  ...
  return (
    <>
            ...
            {[
              {
                ...
                desc: "We pull from multiple sources and normalize the data so you can compare apples to apples.",
              },
              {
                icon: "🌊",
                title: "Hazard Intelligence",
                desc: "Every listing includes flood, landslide, and tsunami risk data from official Japanese sources.",
              },
              {
                icon: "🏷️",
                title: "Lifestyle Matching",
                desc: "Properties are tagged as pet-friendly, artist retreat, remote work ready, and more — with reasons.",
              },
              {
                icon: "⚖️",
                title: "Honest Assessments",
                desc: "Our 'What to Know' section tells you what's attractive, what's unclear, and what's risky.",
              },
              {
                icon: "📊",
                title: "Quality Scoring",
                desc: "Every listing gets a completeness score so you know which ones have reliable data.",
              },
              {
                icon: "🔄",
                title: "Always Fresh",
                desc: "Listings are refreshed regularly. We track availability and mark stale or delisted properties.",
              },
            ].map((item, i) => (
              <div
                key={i}
        ...
        <div className="container" style={{ textAlign: "center" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(300px, 1fr))", gap: 24, maxWidth: 900, margin: "0 auto" }}>
            ...
            <div className="glass-card" style={{ padding: 36 }}>
              ...
              <Link href="/properties" className="btn btn-secondary" style={{ width: "100%", marginTop: 24 }}>
                Start Browsing
              </Link>
            </div>
            ...
            >
              <span className="badge badge-blue" style={{ position: "absolute", top: -12, left: "50%", transform: "translateX(-50%)" }}>
                Most Popular
              </span>
              ...
              <ul style={{ listStyle: "none", textAlign: "left", fontSize: 14, color: "var(--text-secondary)" }}>
                {[
                  ...
                  "Lifestyle matching profiles",
                  "Quality scores & data completeness",
      ...
      <section
        style={{
          padding: "80px 0",
          background: "linear-gradient(135deg, rgba(56,189,248,0.05), rgba(45,212,191,0.05))",
        }}
      >
        <div className="container" style={{ textAlign: "center" }}>
          <h2 style={{ fontSize: 32, marginBottom: 16 }}>
            Ready to find your place in Japan?
          </h2>
          <p style={{ color: "var(--text-secondary)", marginBottom: 32, maxWidth: 500, margin: "0 auto 32px" }}>
            We aggregate the listings. We check the risks.
