    ...
    if (success) {
        return (
            <div style={{ minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center", padding: 24, background: "var(--bg-primary)" }}>
                <div className="glass-card" style={{ width: "100%", maxWidth: 420, padding: 40, textAlign: "center" }}>
                    ...
                    <Link href="/login" className="btn btn-primary" style={{ marginTop: 24, display: "inline-block", padding: "10px 24px" }}>
                        Back to Login
                    </Link>
                </div>
            </div>
            ...
            <div className="glass-card" style={{ width: "100%", maxWidth: 420, padding: 40 }}>
                ...
                <form onSubmit={handleSignup}>
                    <div style={{ marginBottom: 16 }}>
                        <label style={{ display: "block", fontSize: 13, color: "var(--text-secondary)", marginBottom: 6 }}>Display Name</label>
                        <input
                            type="text"
                            value={displayName}
